...
layui.define(['laytpl', 'laypage', 'layer', 'form'], function(exports){
  ...
  Class.prototype.renderData = function(res, curr, count, sort){
    ...
    if(typeof options.response.conbineData === 'function'){
    	data = options.response.conbineData(res);
    }
  ...
  Class.prototype.fullSize = function(){
    ...
    //tbody区域高度
    console.log('height:'+that.layHeader.height());
    var headerHeight = parseFloat(that.layHeader.height())
    if(headerHeight <= 0){
    	headerHeight = 38;
    }
    bodyHeight = parseFloat(height) - headerHeight - 1;  
    if(options.page){
